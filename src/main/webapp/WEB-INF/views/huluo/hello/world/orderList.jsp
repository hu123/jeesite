...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="hello:world:order:edit"><li><a href="${ctx}/hello/world/order/form">一对多增删改查添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				<shiro:hasPermission name="hello:world:order:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="order">
			<tr>
				<shiro:hasPermission name="hello:world:order:edit"><td>
