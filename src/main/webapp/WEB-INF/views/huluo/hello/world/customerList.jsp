...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="cms:article:view"><li><a href="${ctx}/hello/world/customer/form">一对多增删改查添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="customer" action="${ctx}/hello/world/customer/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			<li><label>name：</label>
				<form:input path="customerName" htmlEscape="false" maxlength="10" class="input-medium"/>
			</li>
		...
		<c:forEach items="${page.list}" var="customer">
			...
			<tr>
				<shiro:hasPermission name="cms:article:view">
					<td><a href="${ctx}/hello/world/customer/form?id=${customer.id}">
